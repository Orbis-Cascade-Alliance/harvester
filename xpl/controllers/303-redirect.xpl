...
<![CDATA[<html>
	...
	<body>
		<h1>See Other</h1>
		<p>The answer to your request is located <a href="]]><xsl:value-of select="descendant::res:binding[@name='agg']/res:uri"/><![CDATA[">here</a>.</p>
	</body>
</html>]]>
					</xml>
				</xsl:template>
				...
				<xsl:template match="/">
					<config>
						...
						<header>
							<name>Location</name>
							<value>
								<xsl:value-of select="descendant::res:binding[@name='agg']/res:uri"/>
							</value>
						</header>
					</config>
				</xsl:template>
