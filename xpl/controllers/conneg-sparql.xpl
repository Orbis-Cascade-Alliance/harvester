...
<!-- Ethan Gruber
	Date: September 2020
	Function: copied from Nomisma.org: handle content negotiation for various Accept headers or output request parameters to construct a query to send to Fuseki -->
