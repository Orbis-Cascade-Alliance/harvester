			...
			<p:processor name="oxf:unsafe-xslt">
				...
				<p:input name="config">
					<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
						...
						<xsl:param name="set" select="doc('input:request')/request/parameters/parameter[name='set']/value"/>
						<xsl:param name="ark" select="if (string(doc('input:request')/request/parameters/parameter[name='ark']/value)) then doc('input:request')/request/parameters/parameter[name='ark']/value else 'ark:/'"/>
